...
| [TASK-18](./tasks/TASK-18-dns-doh-dot.md) | `agh-dns`: DoH + DoT | ✅ DONE | DoH axum handlers; DoT stub |
| [TASK-19](./tasks/TASK-19-dns-doq-dnscrypt.md) | `agh-dns`: DoQ + DNSCrypt | ⬜ BLOCKED | No Rust crates for DNSCrypt; DoQ needs QUIC |
| [TASK-20](./tasks/TASK-20-dns-filtering-wire.md) | `agh-dns`: Wire Filtering Engine | ✅ DONE | `FilteringHandler` wires all filtering |
| **PHASE 5 — AGH-DHCP** | | | |
| [TASK-21](./tasks/TASK-21-dhcp-v4.md) | `agh-dhcp`: DHCPv4 Server | ⬜ BLOCKED | Requires raw socket DHCP; stub present |
| [TASK-22](./tasks/TASK-22-dhcp-v6.md) | `agh-dhcp`: DHCPv6 Server | ⬜ BLOCKED | Requires raw socket DHCPv6; stub present |
...
| [TASK-36](./tasks/TASK-36-web-tls.md) | `agh-web`: TLS Configuration | ⬜ BLOCKED | Needs cert loading (TASK-36) |
| **PHASE 9 — AGH-UPDATER** | | | |
...
| **PHASE 11 — DOCKER & CI** | | | |
| [TASK-41](./tasks/TASK-41-dockerfile.md) | Multi-Arch Dockerfile | ⬜ TODO | Needs complete binary (TASK-40 ✅) |
| [TASK-42](./tasks/TASK-42-ci-pipeline.md) | Full CI/CD Pipeline | ✅ DONE | `.github/workflows/rust.yml` |
| **PHASE 12 — TESTING** | | | |
| [TASK-43](./tasks/TASK-43-test-api-contract.md) | API Contract Tests | ⬜ TODO | Tests present but #[ignore] |
| [TASK-44](./tasks/TASK-44-test-dns-compliance.md) | DNS Compliance Tests | ⬜ TODO | Needs DNS server running |
| [TASK-45](./tasks/TASK-45-test-config-migration.md) | Config Migration Tests | ⬜ TODO | Needs full binary |
| [TASK-46](./tasks/TASK-46-test-performance.md) | Performance Benchmarks | ⬜ TODO | Needs full binary |
